 ...
 * to the form and the final CTA. Hidden below `md`, which is exactly where the
 * sticky mobile action bar takes over the bottom of the screen — two fixed
 * elements in the same corner is one too many.
 */
